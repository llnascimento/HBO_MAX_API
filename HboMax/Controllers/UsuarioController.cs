...
namespace HboMax.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        private readonly HboMaxDBContext _context;

        private readonly IUsuarioRepositorio _usuarioReposistorio;

        public UsuarioController(IUsuarioRepositorio usuarioReposistorio, HboMaxDBContext context)
        {
